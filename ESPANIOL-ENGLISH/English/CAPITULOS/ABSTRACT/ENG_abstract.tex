...
\begin{abstract}
	...
	In the end we are going to obtain a phenomenon with the same strengths and weaknesses as two diagonalization techniques used by Cantor. And I use the term 'weaknesses', since the counter-arguments to this phenomenon have a direct 'translation' in the cantorian diagonalizations, where they are not considered as 'weaknesses'. The similarities are going to be wildly amazing
