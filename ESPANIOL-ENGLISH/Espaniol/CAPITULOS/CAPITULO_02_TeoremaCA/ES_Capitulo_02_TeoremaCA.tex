...
El Teorema CA, ha acabado siendo una generalización no intencionada de la función inyectiva, en cuanto a su uso para poder afirmar que el cardinal de un conjunto, no es mayor que el cardinal de otro conjunto. La inyectividad, es un caso particular del teorema.
